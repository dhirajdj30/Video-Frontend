...
const RoomPage = () => {
  ...
  return (
    <div className="room-container">
      ...
      {myStream && <button onClick={sendStreams} className="room-button">Send Stream</button>}
      {remoteSocketId && <button onClick={handleCallUser} className="room-button">CALL</button>}
      {myStream && (
